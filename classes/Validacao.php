...
class Validacao
{
    ...
    function mensagens($num, $campo, $max, $min)
    {
        ...
        $this->msg[0] = "Preencha o campo com um email valido <br />"; // EMAIL
        ...
        $this->msg[7] = "URL especificada a invalida (Ex: http://www.google.com) <br />"; // URL
        ...
        $this->msg[10] = "O " . $campo . " deve ter no manimo " . $min . " caracteres <br />"; // MINIMO DE CARACTERES
